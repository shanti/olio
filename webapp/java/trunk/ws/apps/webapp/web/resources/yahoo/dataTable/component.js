...
jmaki.widgets.yahoo.dataTable.Widget = function(wargs) {
    ...
    function init() { 	
	   ...
	   _widget.dataTable.subscribe("editorUpdateEvent", function(args) {
	        var pub = { widgetId : wargs.uuid, columnId : args.editor.column.key, columnIndex : args.editor.column._nKeyIndex, record : args.editor.record, value : args.editor.value, rowId : getRecordMapping(args.editor.record._sId)};
